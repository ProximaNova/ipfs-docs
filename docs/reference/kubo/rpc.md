...
::: tip Generated on 2025-08-27, from kubo v0.36.0
This document was autogenerated from [v0.36.0](https://github.com/ipfs/kubo/releases/tag/v0.36.0).
...
`curl -X POST -F file=@myfile "http://127.0.0.1:5001/api/v0/add?quiet=<value>&quieter=<value>&silent=<value>&progress=<value>&trickle=<value>&only-hash=<value>&wrap-with-directory=<value>&chunker=<value>&raw-leaves=<value>&max-file-links=<value>&max-directory-links=<value>&max-hamt-fanout=<value>&nocopy=<value>&fscache=<value>&cid-version=<value>&hash=<value>&inline=<value>&inline-limit=32&pin=true&to-files=<value>&preserve-mode=<value>&preserve-mtime=<value>&mode=<value>&mtime=<value>&mtime-nsecs=<value>"`
...
- `remove-bad-blocks` [bool]: remove bad blocks. WARNING: This may remove pinned data. You should run &#39;ipfs pin verify&#39; after running this command and correct any issues. Required: no.
...
Read and outpt log messages.

### Arguments

- `log-level` [string]: Log level to listen to. Default: . Required: no.
...
`curl -X POST "http://127.0.0.1:5001/api/v0/log/tail?log-level=<value>"`
...
- `mfs-path` [string]: The path where MFS should be mounted. Required: no.
...
Returns statistics about the node&#39;s reprovider system.
...
Deprecated command, use &#39;ipfs stats reprovide&#39; instead.
